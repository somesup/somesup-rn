...
import { ImageBackground, View, Text, Pressable, ActivityIndicator, Alert } from "react-native";
...
export default function MyPageScreen() {
  ...
  const preferenceRadii = sectionLabels.map((label) => (sectionsMap[label]?.preference ?? 1) * 30);
  const behaviorRadii = sectionLabels.map((label) => (sectionsMap[label]?.behaviorScore ?? 1) * 30);
      ...
      <View className="pt-16 px-7 pb-8">
        ...
        >
          <View className="flex-row items-center">
            ...
            <Text className="text-[#FAFAFA] ml-3 typography-body1">스크랩 목록</Text>
          </View>
          <MaterialIcons name="chevron-right" size={20} color="#FAFAFA" />
        </Pressable>

        <View className="mb-4">
          <Text className="mb-2 typography-body2 text-[#FAFAFA]">내가 읽은 뉴스</Text>
          ...
          <View className="items-center overflow-hidden rounded-xl bg-[#2E2E2E]">
            ...
            <View className="-mt-2 mb-3 flex-row">
              <View className="flex-row items-center">
                ...
                <Text className="ml-2 typography-caption3 text-[#FAFAFA]">읽은 뉴스</Text>
              </View>
              ...
              <View className="flex-row items-center">
                ...
                <Text className="ml-2 typography-caption3 text-[#FAFAFA]">선호도</Text>
              </View>
            </View>
            ...
            >
              <Text className="typography-body2 text-[#FAFAFA]">관심 카테고리 수정</Text>
              <MaterialIcons name="chevron-right" size={20} color="#FAFAFA" />
            </Pressable>
          </View>
        </View>
        ...
        <View className="mb-8">
          <Text className="mb-2 typography-body2 text-[#FAFAFA]">자주 접한 키워드</Text>
